...
Widget unlinked_areix(BuildContext context){
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              Row(children: [
                Text("+\$100",style: TextStyle(fontSize:screenSize.width/15,color:kBackgoundColor4),),
                SizedBox(width: screenSize.width/30,),
                Column(
                  children: [

                    Text("Avg. reward\namong Areix users",style: TextStyle(height:screenSize.width/300,fontSize:screenSize.width/36,color:kBackgoundColor4),),
                  ],
                )
